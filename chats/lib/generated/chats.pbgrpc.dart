...
class ChatsRpcClient extends $grpc.Client {
  ...
  static final _$sendMessage = $grpc.ClientMethod<$0.MessageDto, $0.ResponseDto>(
      ...
      ($core.List<$core.int> value) => $0.ResponseDto.fromBuffer(value));
  static final _$deketeMessage = $grpc.ClientMethod<$0.MessageDto, $0.ResponseDto>(
      '/ChatsRpc/DeketeMessage',
      ($0.MessageDto value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResponseDto.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.ResponseDto> deketeMessage($0.MessageDto request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deketeMessage, request, options: options);
  }
...
abstract class ChatsRpcServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.ResponseDto> deketeMessage_Pre($grpc.ServiceCall call, $async.Future<$0.MessageDto> request) async {
    return deketeMessage(call, await request);
  }
  ...
  $async.Future<$0.ResponseDto> deketeMessage($grpc.ServiceCall call, $0.MessageDto request);
