...
const ChatDto$json = {
  ...
  '2': [
    ...
    {'1': 'authorId', '3': 3, '4': 1, '5': 9, '10': 'authorId'},
...
final $typed_data.Uint8List chatDtoDescriptor = $convert.base64Decode(
    'CgdDaGF0RHRvEg4KAmlkGAEgASgJUgJpZBISCgRuYW1lGAIgASgJUgRuYW1lEhoKCGF1dGhvck'
    'lkGAMgASgJUghhdXRob3JJZBInCghtZXNzYWdlcxgEIAMoCzILLk1lc3NhZ2VEdG9SCG1lc3Nh'
    'Z2Vz');
...
const MessageDto$json = {
  ...
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    {'1': 'chatId', '3': 2, '4': 1, '5': 9, '10': 'chatId'},
...
final $typed_data.Uint8List messageDtoDescriptor = $convert.base64Decode(
    'CgpNZXNzYWdlRHRvEg4KAmlkGAEgASgJUgJpZBIWCgZjaGF0SWQYAiABKAlSBmNoYXRJZBIaCg'
    'hzZW5kZXJJZBgDIAEoCVIIc2VuZGVySWQSEgoEYm9keRgEIAEoCVIEYm9keRISCgRkYXRlGAUg'
    'ASgJUgRkYXRl');
